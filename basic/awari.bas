...
212 F=0
215 FOR I=0 TO 5:IF B(I)<>0 THEN F=1
220 NEXT I
225 IF F=0 THEN RETURN
...
615 IF B(M)=1 THEN IF M<>6 THEN IF M<>13 THEN IF B(12-M)<>0 THEN GOTO 625
620 RETURN
625 B(H)=B(H)+B(12-M)+1:B(M)=0:B(12-M)=0:RETURN
800 D=-99:H=13
805 FOR I=0 TO 13:G(I)=B(I):NEXT I
810 FOR J=7 TO 12:IF B(J)=0 THEN GOTO 885
815 G=0:M=J:GOSUB 600
820 FOR I=0 TO 5:IF B(I)=0 THEN GOTO 845
825 L=B(I)+I:R=0
