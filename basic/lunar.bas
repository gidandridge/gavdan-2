...
160 PRINT " (YES OR NO)";
165 INPUT Q$
170 IF Q$="YES" THEN GOTO 190
175 IF Q$="NO" THEN GOTO 205
...
225 INPUT K
230 PRINT
235 IF K=0 THEN GOTO 280
240 IF K=1 THEN GOTO 250
245 GOTO 220
250 Z=1852.8
255 M$="METERS"
260 O3=3.6
...
370 PRINT "0 (ZERO) DEGREES IS DIRECTLY TOWARD THE MOON"
380 PRINT
...
585 INPUT T1,F,P
590 F=F/100
595 IF T1<0 THEN GOTO 905
600 IF T1=0 THEN GOTO 1090
605 IF ABS(F-.05)>1 THEN GOTO 945
610 IF ABS(F-.05)<.05 THEN GOTO 945
615 IF ABS(P)>180 THEN GOTO 925
620 N=20
625 IF T1<400 THEN GOTO 635
630 N=T1/20
635 T1=T1/N
640 P=P*3.14159/180
645 S=SIN(P)
...
665 A3=-2*R1*A1/R
670 FOR I=1 TO N
675 IF M1=0 THEN GOTO 715
680 M1=M1-M2
685 IF M>0 THEN GOTO 725
690 F=F*(1+M1/M2)
695 M1=M1-M2
...
790 M=M-.5*M2
795 T=T+T1
800 IF H0<3.287828E-04 THEN GOTO 810
805 NEXT I
810 H=H0*Z
815 H1=R1*Z
820 D=R0*A*Z
825 D1=R*A1*Z
830 T2=M1*B/M0
835 PRINT TAB(60);T2;CHR$(13);TAB(49);D1;CHR$(13);TAB(37);H1;CHR$(13);
840 PRINT TAB(23);D;CHR$(13);TAB(10);H;CHR$(13);" ";T
845 IF H0<3.287828E-04 THEN GOTO 880
850 IF R0*A>164.4736 THEN 1050
855 IF M1>0 THEN GOTO 580
860 T1=20
865 F=0
870 P=0
875 GOTO 620
880 IF R1<-8.21957E-04 THEN GOTO 1020
885 IF ABS(R*A1)>4.931742E-04 THEN GOTO 1020
890 IF H0<-3.287828E-04 THEN GOTO 1020
895 IF ABS(D)>10*Z THEN GOTO 1065
900 GOTO 995
905 PRINT
...
955 IF F<0 THEN GOTO 985
960 IF F-.05<.05 THEN GOTO 975
965 PRINT "TOO LARGE"
970 GOTO 575
975 PRINT "TOO SMALL"
980 GOTO 575
...
1110 INPUT Z$
1115 IF Z$="YES" THEN GOTO 20
1120 IF Z$="NO" THEN GOTO 1130
1125 GOTO 1105
1130 PRINT
...
1180 INPUT B1
1185 Q$="NO"
1190 IF B1=1 THEN GOTO 205
1195 Q$="YES"
1200 IF B1=2 THEN GOTO 190
1205 IF B1=3 THEN GOTO 190
1210 GOTO 1165
1215 END
